					...
					<div class="ss-popup-networks ss-clearfix">
						...
						foreach ( $all_networks as $id => $name ) {
							...
							<div class="ss-popup-network ss-popup-<?php echo esc_attr( $id ); ?>">
								<a href="#" data-ss-ss-link="<?php echo esc_url( $share_url, $allowed_protocols ); ?>" data-id="<?php echo esc_attr( $id ); ?>" class="<?php echo esc_attr( $icon_class ); ?>" <?php echo $additional_data; ?> rel="nofollow noopener">
			...
			if ( 'pin_it' === $args['type'] || is_admin() ) {
				...
				if ( $share_url ) {
					...
					<ul class="ss-social-icons-container ss-on-media-pinit">
						<li>
							<div data-ss-ss-link="<?php echo esc_url( $share_url ); ?>" class="ss-pinterest-color ss-pinit-button ss-ss-on-media-button">
			...
			foreach ( $data['options']['networks'] as $network => $network_settings ) {
				...
				<li class="<?php echo esc_attr( $hide_class ); ?>">
					...
					<?php if ( 'on_media' === $location ) { ?>
						...
						<div data-ss-ss-link="<?php echo esc_url( $share_url ); ?>" class="<?php echo esc_attr( $icon_class ); ?>" <?php echo $additional_data; ?>>
					<?php } else { ?>

						<?php $icon_class = apply_filters( 'socialsnap_social_share_button_class', 'ss-' . $network . '-color', $network, $data['post_id'] ); ?>

						<a href="#" data-ss-ss-link="<?php echo esc_url( $share_url ); ?>" class="<?php echo esc_attr( $icon_class ); ?>" rel="nofollow noopener" <?php echo $additional_data; ?>>
					<?php } ?>
