	...
	<table class="wpos-plugin-pricing-table">
		...
		<thead>
			<tr>
				...
				<th>
					<h2>Premium</h2>
					<p>Gain access to <strong>Styles for WP Pagenavi Addon</strong> included in <br /><strong>Essential Plugin Bundle</p>
		...
		<tfoot>
			<tr>
				<th></th>
				<td></td>
				<td><p>Gain access to <strong>Styles for WP Pagenavi Addon</strong> included in <br /><strong>Essential Plugin Bundle</p>
				<a href="https://www.wponlinesupport.com/pricing/?ref=WposPratik&utm_source=WP&utm_medium=WP-Pagenavi&utm_campaign=Upgrade-PRO" target="_blank">View Buying Options</a></td>
			</tr>
		</tfoot>
	</table>
</div>